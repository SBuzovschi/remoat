...
This Code of Conduct applies within all project spaces — GitHub issues, pull requests, discussions, and any other communication channel used by the project. It also applies when an individual is representing the project in public spaces.
